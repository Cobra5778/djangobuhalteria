...
def sf_result(request):
    ...
    for in_Date in table_data:
        ...
        try:
            ...
            summBILL += 0            
    return render(request, 'query/sf_result.html', {'table_data' : table_data, 'summSF' : summSF, 'summBILL' :summBILL, 'summ' : (summSF - summBILL) })
